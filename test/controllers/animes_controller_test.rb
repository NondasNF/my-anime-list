...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { classification: @anime.classification, gender: @anime.gender, name: @anime.name } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { classification: @anime.classification, gender: @anime.gender, name: @anime.name } }
